...
namespace apsu {
    namespace util {
            ...
            const Modulus &mod)
        {
            ...
            std::string strlabel(label.begin(), label.end());
            uint64_t intlabel = stoi(strlabel);
            // std::cout << "intlabel = " << intlabel << " " << label.size() << std::endl;
            vector<felt_t> alg_label;
            alg_label.push_back(intlabel);
            ...
            //std::cout << "felts_per_item = " << felts_per_item << " label_size = " << label_size << "  " << alg_label.size() << std::endl;
            ...
            for (size_t felt_item_idx = 0; felt_item_idx < felts_per_item; felt_item_idx++) {
                ...
                for (size_t label_idx = 0; label_idx < label_size; label_idx++) {
                    ...
                    //std::cout << alg_label[felts_per_item * label_idx + felt_item_idx] << " ";
                }
